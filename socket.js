// backend/socket.js
// Final full file — copy & paste to replace your existing socket.js
 ...
 * Convenience to clear activeRoom and set status to 'idle' for players in a room.
 */
    ...
    socket.on(
      ...
      ({ roomId: requestedRoomId, minutes, colorPreference, user }) => {
        try {
          ...
          // IMPORTANT CHANGE: Do NOT attempt to pre-reserve activeRoom for single-user create here.
          // Reservation will happen when the user actually is assigned a playing seat (markUserActiveRoom).
          // (Matchmaking/challenge flows that require reservation are handled elsewhere.)
